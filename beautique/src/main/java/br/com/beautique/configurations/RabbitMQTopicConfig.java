...
@Configuration // defined as a bean, and managed by spring
public class RabbitMQTopicConfig {
    ...
    @Bean
    public Queue customerQueue() { // create of queue
    ...
    @Bean public Binding bindingBeautyProcedures(Queue beautyProcedureQueue, TopicExchange exchange) {
        return BindingBuilder.bind(beautyProcedureQueue)
                .to(exchange).with("beautyProcedures.#");
    }
    ...
    @Bean public Binding bindingAppointments(Queue appointmentQueue, TopicExchange exchange) {
        return BindingBuilder.bind(appointmentQueue)
                .to(exchange).with("appointments.#");
    }
}
